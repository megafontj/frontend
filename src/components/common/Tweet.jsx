...
export const Tweet = ({item, getTweets}) => {
    ...
    return (
        <div className='my-4 p-4 border border-white rounded-lg'>
            {!isEditMode ? (
                ...
                <div className='text-black'>
                    <textarea  className='textarea textarea-primary overflow-hidden w-full'
                               rows={6}
